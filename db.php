...
if ( 'mdi-native' === MARKDOWN_DB_BACKEND ) {
	...
	$markdown_db_native_runtime = $markdown_db_native_multisite
		...
		: WP_Markdown_Native_Runtime_Factory::runtime( $markdown_db_native_state_dir, $markdown_db_native_prefix, $markdown_db_native_prefix, false, $markdown_db_native_content_dir );
