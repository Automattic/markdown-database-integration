...
$mysql_full_no_publisher = WP_Markdown_Health::diagnose( array( 'mode' => 'primary', 'sqlite_runtime' => false, 'mysql_full_boundary' => true, 'mysql_full_sink' => true, 'mysql_full_outbox_diagnostics' => $outbox_diagnostics, 'mysql_full_semantic_drain' => $semantic_drain, 'mysql_full_publisher_ready' => false, 'backend_capabilities' => WP_Markdown_Backend_Capabilities::mysql_full() ) );
mdi_health_assert( 'mysql_full_canonical_publisher_unavailable' === $mysql_full_no_publisher['status'] && ! $mysql_full_no_publisher['healthy'], 'MySQL full-primary fails closed when canonical publication is unavailable' );
$mysql_full = WP_Markdown_Health::diagnose( array( 'mode' => 'primary', 'sqlite_runtime' => false, 'mysql_full_boundary' => true, 'mysql_full_sink' => true, 'mysql_full_outbox_diagnostics' => $outbox_diagnostics, 'mysql_full_semantic_drain' => $semantic_drain, 'mysql_full_publisher_ready' => true, 'backend_capabilities' => WP_Markdown_Backend_Capabilities::mysql_full() ) );
mdi_health_assert( 'mysql_full_canonical_publication_ready' === $mysql_full['status'] && $mysql_full['healthy'] && $outbox_diagnostics === $mysql_full['outbox'], 'MySQL full-primary reports durable canonical publication readiness' );
