 ...
 *
 * SQLite modes (MARKDOWN_DB_MODE, explicit 'sqlite' backend only):
...
define( 'MARKDOWN_DB_VERSION', '0.13.10' );
...
require_once MARKDOWN_DB_PLUGIN_DIR . 'inc/sqlite/class-wp-markdown-sqlite-recovery.php';
require_once MARKDOWN_DB_PLUGIN_DIR . 'inc/class-wp-markdown-backend-capabilities.php';
require_once MARKDOWN_DB_PLUGIN_DIR . 'inc/native/class-wp-markdown-native-query-runtime.php';
require_once MARKDOWN_DB_PLUGIN_DIR . 'inc/native/class-wp-markdown-native-wpdb.php';
require_once MARKDOWN_DB_PLUGIN_DIR . 'inc/native/class-wp-markdown-native-shadow-verifier.php';
