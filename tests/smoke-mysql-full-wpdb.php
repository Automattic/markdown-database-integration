...
mdi_mysql_full_assert( array( 'type' => 'DDL', 'op' => 'TRUNCATE', 'table' => 'wp_items' ) === WP_Markdown_SQL_Classifier::mutation( "/* SQL comment */\nTRUNCATE TABLE `wp_items`" ), 'classifier admits leading-comment mutations' );
