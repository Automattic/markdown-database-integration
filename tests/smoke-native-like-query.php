...
$not_like = $runtime->execute( new WP_Markdown_Query_Request( "SELECT ID FROM wp_posts WHERE post_type = 'post' AND post_title NOT LIKE '%Hello%'", 'wp_' ) );
...
$checks = array(
	...
	'NOT LIKE excludes ASCII matches' => array( '12', '13' ) === $ids( $not_like ),
);
